...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { name: @column.name, table_id: @column.table_id, type_id: @column.type_id } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { name: @column.name, table_id: @column.table_id, type_id: @column.type_id } }
